...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url();?>workflows/index" aria-expanded="true" aria-controls="collapseTwo">
        ...
        <a class="nav-link collapsed" href="<?php echo base_url();?>workflows/index" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <span>Manage your Property</span>
            ...
            <hr class="sidebar-divider">
            <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('contracts/add');?>" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fas fa-fw fa-cog"></i>
      ...
      <li class="nav-item">
        ...
        <div id="contractbidding-tab" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-transparent py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url();?>bidding/current">Active (Approved) </a>
            <a class="collapse-item" href="<?php echo base_url();?>bidding/pending">Pending Approval</a>
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                  <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="text-transform:capitalize; font-weight:bold;">{name}</span>
