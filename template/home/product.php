						...
						<div class="post-body">
							<div class="entry-header">
								...
								<h2 class="entry-title">
					 				<a href="<?=base_url();?>home/product_details">3 Plots of Land for Sale</a>
					 			</h2>
							</div><!-- header end -->

							<div class="entry-content">
								<p>This is a sample of the description of the land, shouldnt have many contents on it anyway.</p>
							</div>

							<div class="post-footer">
								<a href="<?=base_url();?>home/product_details" class="btn btn-primary btn-sm d-inline">More details</a> <h3 class="d-inline text-danger ml-1">
					 			#55,000,000</h3>
							</div> 
