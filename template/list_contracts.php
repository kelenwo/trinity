...
</span> <h3 class="inline">Edit Contract</h3>
  </div>
 </div>
...
<div class="row">
   <div class="col-sm-6 col-md-6">
           <div class="ml-3 mt-1">
           <div class="text-sm text-primary text-capitalize"><small class="text-success">Lifecycle (has renewal?):</small>
           <br>
         <h6><?php echo $req['has_renewal'];?></h6></div>
         <br>
       ...
       <h6><?php echo date("d F Y", strtotime($req['start_date']));?></h6></div>
         ...
         <div class="col-sm-5 col-md-5 ml-4 mt-2">
           ...
           <br>
         <h6><?php echo date("d F Y", strtotime($req['renewal_period']));?></h6></div><br>
...
<div class="row">
   <div class="col-sm-6 col-md-6">
           ...
           <br>
         <h6><?php echo $req['billing_amount'];?></h6></div>
         <br>
 ...
 <br>
<h6><?php echo date("d F Y", strtotime($req['first_billing_date']));?></h6></div><br>
         <div class="text-sm text-primary text-capitalize"><small class="text-success">Last Billing date:</small>
         <br>
       <h6><?php echo date("d F Y", strtotime($req['last_billing_date']));?></h6></div>
         </div>
       </div>
     </div>
       </div>
